...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines - Líneas de lenguaje de validación
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado ha aparecido en una fuga de datos. Por favor, elige un :attribute diferente.',
    ],
